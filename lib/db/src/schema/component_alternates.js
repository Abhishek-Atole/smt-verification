...
export const componentAlternatesTable = pgTable("component_alternates", {
    ...
    uniqueAlternate: unique("unique_component_alternate").on(table.primaryComponentId, table.alternateComponentId),
}));
