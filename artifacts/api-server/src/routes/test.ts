...
// ⚠️ WARNING: Test endpoints disabled in production
function isProduction() {
  return process.env.NODE_ENV === "production";
}

function productionGuard(req: Request, res: Response): boolean {
  if (isProduction()) {
...
/**
 * POST /api/test/seed-simple - Seed database with sample data (DEV ONLY)
 */
...
/**
 * POST /api/test/seed - Seed database with sample data (DEV ONLY)
...
/**
 * POST /api/test/clear - Clear all data from database (DEV ONLY)
 ...
 */
/**
 * GET /api/test/stats - Get test database stats (DEV ONLY)
 */
