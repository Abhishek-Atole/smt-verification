 ...
 */
router.get("/traceability/reel/:reelId", requireRole("operator", "qa", "supervisor", "admin"), async (req: AuthRequest, res) => {
  try {
 ...
 */
router.get("/traceability/lot/:lotNumber", requireRole("operator", "qa", "supervisor", "admin"), async (req: AuthRequest, res) => {
  try {
 ...
 */
router.get("/traceability/date-code/:dateCode", requireRole("operator", "qa", "supervisor", "admin"), async (req: AuthRequest, res) => {
  try {
    const dateCode = String(req.params.dateCode);
 ...
 */
router.get("/traceability/session/:sessionId/trace", requireRole("operator", "qa", "supervisor", "admin"), async (req: AuthRequest, res) => {
  try {
 ...
 */
router.get("/traceability/sessions-for-reel/:reelId", requireRole("operator", "qa", "supervisor", "admin"), async (req: AuthRequest, res) => {
  try {
    const reelId = String(req.params.reelId);
 ...
 */
router.get("/traceability/sessions-for-lot/:lotNumber", requireAuth, async (req, res) => {
  try {
    const lotNumber = String(req.params.lotNumber);
 ...
 */
router.get("/traceability/alternate-usage", requireAuth, async (req, res) => {
  try {
